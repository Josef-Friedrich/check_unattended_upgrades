...
class TestWarningsInLog(unittest.TestCase):
    def test_error(self) -> None:
        ...
        result.assert_output(
            "UNATTENDED_UPGRADES CRITICAL - Sperrung konnte nicht erreicht werden (läuft eine weitere Paketverwaltung?)"
        )
    ...
    def test_warning(self) -> None:
        ...
        result.assert_output(
            "UNATTENDED_UPGRADES WARNING - Found /var/run/reboot-required, rebooting, Shutdown msg: b\"Shutdown scheduled for Fri 2022-12-02 04:00:00 CET, use 'shutdown -c' to cancel.\""
        )
        result.assert_warn()
